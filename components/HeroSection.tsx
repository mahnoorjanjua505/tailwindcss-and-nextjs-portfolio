...
const HeroSection = () => {
  return (
    <section id="home">
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-14 py-15 sm:py-32 md:py-40 md:flex-row md:space-x-4 md:text-left">
